...
<section class="hero-slider" aria-label="Hero Slider">
    ...
    <?php else : ?>
        ...
        <!-- Fallback hero ketika belum ada slide -->
        <div class="hero-slide">
            <div class="hero-slide-bg hero-slide-placeholder"></div>
            <div class="hero-slide-overlay"></div>
            <div class="container">
                <div class="hero-slide-content">
                    <h1 class="hero-slide-title">DPW PSI Papua Pegunungan</h1>
                    <div class="hero-slide-text">Dewan Pimpinan Wilayah Partai Solidaritas Indonesia Provinsi Papua Pegunungan. Bersama membangun Papua Pegunungan yang lebih baik.</div>
                    <a href="<?php echo esc_url( dpw_psi_get( 'reg_link_cta', 'https://psi.id/daftar-anggota' ) ); ?>" class="hero-slide-btn" target="_blank" rel="noopener">
                        Daftar Anggota PSI <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
